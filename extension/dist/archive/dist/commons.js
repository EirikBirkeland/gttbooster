...
var globToRegexp = __webpack_require__(191);
    ...
    var handler = {
        get: function get(target, propKey, receiver) {
            ...
            return function () {
                ...
                var pattern = globToRegexp(localStorage['cth-debug']);

                if (pattern.test(scopename)) {
                    if (opts.quiet) {
                        return;
                    }
                    var _result = origMethod.apply(this, args);
                    return _result;
                } else {
...
(function () {
	...
	} else if ("function" === 'function' && _typeof(__webpack_require__(100)) === 'object' && __webpack_require__(100)) {
...
var _tool = __webpack_require__(43);

var _localforage = __webpack_require__(78);

var _localforage2 = _interopRequireDefault(_localforage);

var _ChromeProxy = __webpack_require__(44);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var debug = __webpack_require__(1)(__filename.replace(/^src\//, ''));
...
var Storage = function () {
   ...
   var backgroundVersion = function () {

      function set(opts, key, value, cb) {

         var store = _localforage2.default.createInstance({ "name": opts.storeName });

         if (Array.isArray(key)) {

            key.forEachAsync(function (ele) {
   ...
   var contentVersion = function () {

      var sendMessage = _ChromeProxy.ChromeProxy.runtime.sendMessage;
      var common = { "header": 'storage'
          ...
          */
      };function _get(opts, key, cb) {
         // I could just add an obligatory collection name for get/set ...
      ...
      var get = (0, _tool.promisify)(_get);
      ...
      var set = (0, _tool.promisify)(_set);
      ...
      var keys = (0, _tool.promisify)(_keys);
      ...
      var remove = (0, _tool.promisify)(_remove);
...
/* WEBPACK VAR INJECTION */}.call(exports, "src/model/GeneralStorage.js"))
...
var notifier = exports.notifier = function () {
   ...
   var applyStyles = function applyStyles(element, styleObject) {
   ...
   return {
      notify: function notify(message, delay, title, image) {
         ...
         var icon = (0, _jquery2.default)('<img/>').attr('src', image)[0];
         ...
         if (title) {
            ...
            var titleText = (0, _jquery2.default)('<div/>')[0];
            applyStyles(titleText, config.title_styles);
            titleText.appendChild((0, _jquery2.default)('<span/>').html(title)[0]);
            text.appendChild(titleText);
         }

         if (message) {

            var messageText = (0, _jquery2.default)('<div/>')[0];
            messageText.appendChild((0, _jquery2.default)('<span/>').html(message)[0]);
      ...
      info: function info(message, delay) {
      ...
      warning: function warning(message, delay) {
      ...
      success: function success(message, delay) {
      ...
      error: function error(message, delay) {
...
var _Symbol = __webpack_require__(24).Symbol;
...
var uniqFilter = function uniqFilter(ele, i, arr) {
   return arr.indexOf(ele) === i;
};

function contrastColor(hexColor) {
   var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
   // Takes a hex string such as "ab12ef" + integer 0, 1

   var rgb = hexColor.match(/.{2}/g);
   ...
   switch (option) {
      ...
      case 1:
         ...
         break;
      case 2:
         // Luminance (perceived option 2, slower to calculate): (NB: This may not be working currently!)
...
function promisify(fn) {
   ...
   return function () {
      ...
      return new Promise(function (resolve, reject) {
         ...
         fn.call.apply(fn, [this].concat(args, [function (result) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(__filename, global) {
...
var debug = __webpack_require__(193)(__filename);
var isNode = typeof window === 'undefined' && (typeof global === 'undefined' ? 'undefined' : _typeof(global)) === 'object';

var chromeNamespaceMock = {
   "runtime": {
      "sendMessage": function sendMessage() {

         var msg = 'MOCK of chrome.runtime.sendMessage: ';

         for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
         }

         debug.apply(undefined, [msg].concat(_toConsumableArray(args)));
      },
...
var ChromeProxy = isNode || !chrome.runtime || !chrome.storage ? chromeNamespaceMock : window.chrome;

exports.ChromeProxy = ChromeProxy;
/* WEBPACK VAR INJECTION */}.call(exports, "src/model/ChromeProxy.js", __webpack_require__(79)))
...
Array.prototype.forEachAsync = function recurFn(cb) {
  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

  if (_typeof(this) !== 'object') {
    return console.error('Can only iterate an array or array-like! You provided an item of type ' + _typeof(this));
  }
  if (this[index]) {
...
/**
 *
 * This is the master config file. It should contain those values which are likely to change with time.
 */

module.exports = {
  /**
   *  Unique trial days allowed.
   */
  UNIQUE_DAYS_ALLOWED: 10,
  /**
   * Which mode to use for the Store/Shop website... "PRODUCTION" or "DEVELOPMENT"
   */
  SHOP_MODE: "PRODUCTION",

  /**
   * URL to the official store
   */
  GTT_BOOSTER_STORE_URL: "https://www.gtt-booster.com",

  /**
   *
   */
  LOCAL_EXTENSION_URL: "chrome-extension://pjankaakojbendjaejlcnpgeldmfpjed",

  /**
   * REST server host name
   */
  REST_SERVER_HOST_NAME: "api.gtt-booster.com",

  /**
   * Full API URL
   */
  API_URL: "https://api.gtt-booster.com",

  BASE_URL: "https://base.gtt-booster.com"
};
...
exports.resetToDefaults = exports.save = exports.load = undefined;
...
function load(settings, cb) {
   ...
   _ChromeProxy.ChromeProxy.storage.local.get(settings, function (retrievedSettings) {
...
function _transformSettings(retrievedSettings) {
   var _loop = function _loop(key) {
      ...
      if (Array.isArray(retrievedSettings[key])) {
         ...
         _lodash2.default.forEach(retrievedSettings[key], function (ele, i) {

            retrievedSettings[key][i] = (0, _tool.parseStringifiedValue)(retrievedSettings[key][i]);
         });
      } else {

         retrievedSettings[key] = (0, _tool.parseStringifiedValue)(retrievedSettings[key]);
      }
   };
   ...
   try {
      ...
      for (var _iterator = Object.keys(retrievedSettings)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
         var key = _step.value;
...
function save(settings, cb) {
   ...
   _lodash2.default.forOwn(settings, function (value, key) {

      if (Array.isArray(settings[key])) {

         obj[key] = [];

         _lodash2.default.forEach(settings[key], function (ele, i) {

            obj[key][i] = typeof settings[key][i] === 'string' ? settings[key][i].replace(/\s+/g, '') : settings[key][i];
         });
      } else {
   ...
   _ChromeProxy.ChromeProxy.storage.local.set(obj, function () {
...
function resetToDefaults(settings, defaults) {
   ...
   save(settings, (_context = location, location.reload).bind(_context));
}

exports.load = load;
exports.save = save;
exports.resetToDefaults = resetToDefaults;
/* WEBPACK VAR INJECTION */}.call(exports, "src/model/SettingsStorage.js"))
...
exports.defaults = exports.settings = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _settingsAutocomplete = __webpack_require__(357);

var _settingsQa = __webpack_require__(358);

var _settingsSpreadsheet = __webpack_require__(359);

var _settingsSpellcheck = __webpack_require__(360);

var _settingsTranslationConsole = __webpack_require__(361);
...
var settings = _extends({}, _settingsQa.languageSpecificQaSettings, _settingsAutocomplete.autocompleteSettings, _settingsSpellcheck.spellcheckSettings, _settingsSpreadsheet.spreadsheetSettings, _settingsQa.qaSettings, otherSettings, _settingsTranslationConsole.translationConsoleSettings);

var defaults = Object.keys(settings).reduce(function (acc, ele) {
...
/* WEBPACK VAR INJECTION */}.call(exports, "src/options/settings.js"))
...
function loadAnalytics() {
   ...
   _gaq.push(['_setAccount', 'UA-68260399-4']);
...
function addButtonListeners() {
   ...
   for (var _i = 0; _i < input.length; _i++) {
      ...
      input[_i].addEventListener('click', _trackButtonClick);
   }
...
exports.loadAnalyticsNew = loadAnalyticsNew;
exports.addButtonListeners = addButtonListeners;
/* WEBPACK VAR INJECTION */}.call(exports, "src/workbench/5_init/init/analytics.js"))
...
var _escapeHtml = __webpack_require__(281);
...
var _ = __webpack_require__(2);
var Tabletop = __webpack_require__(142);
var debug = __webpack_require__(1)(__filename.replace(/^src\//, ''));
...
var Sheet = exports.Sheet = function () {
   ...
   function Sheet(opts /*: Object*/) {
      ...
      var url = opts.url,
          ...
          debug = opts.debug,
          tabletopMock = opts.tabletopMock;
   ...
   _createClass(Sheet, [{
      key: 'fetch',
      value: function fetch(cb /*: Function*/) {
         var _this = this;

         this.Tabletop.init({
            "key": this.url,
            "sheetId": 1,
            "callback": function callback(err, resData) {

               debug.log('Err: ', err);

               debug.log('Fetched data: ', resData);

               _this.retrievedSheetNames = resData ? Object.keys(resData) : null;

               debug.log(_this.retrievedSheetNames);

               if (!resData) {

                  _this.onError(_this.messages.noData);
               } else if (!resData[_this.sheetnameToFetch]) {

                  _this.onError(_this.messages.sheetMissing);
               } else {

                  var data /*: Object*/ = _this._filter(_this.sheetnameToFetch, resData);
                  _this.data = data;
               ...
               return cb(err, resData, _this.retrievedSheetNames);
            },
            "simpleSheet": false,
            "debug": this.debug
         });
      ...
      key: '_processTheUrl',
      value: function _processTheUrl() /*: void*/ {
         ...
         var publicSpreadsheetUrl = this.url;
      ...
      key: '_filter',
      value: function _filter(sheetnameToFetch /*: string*/, data /*: Object*/) /*: Object*/ {

         _.forEach(data[sheetnameToFetch].elements, function (ele, i, arr) {

            arr[i].correction = (0, _escapeHtml2.default)(arr[i].correction);
         });

         // Filter out those items that are "ON"
         return data[sheetnameToFetch].elements.filter(function (ele) {
            return ele.toggle === 'on';
         });
      }
   }, {
      key: '_validate',
      value: function _validate(data /*: Object*/) /*: void*/ {
         ...
         var validKeys = ['priority', 'products', 'source_pattern', 'target_pattern', 'correction', 'toggle', 'special', 'case_sensitive', 'match_type', 'comment'];

         var sheetKeys = Object.keys(data[0]);
...
/* WEBPACK VAR INJECTION */}.call(exports, "src/model/qa-sheet-google.js"))
...
(function () {
    ...
    if (inNodeJS) {
        ...
        request = __webpack_require__(143);
    }
...
__webpack_require__(36)(IteratorPrototype, __webpack_require__(19)('iterator'), function () {
  return this;
});
...
module.exports = {
  ...
  function (test, buggy, set) {
    try {
      set = __webpack_require__(85)(Function.call, __webpack_require__(130).f(Object.prototype, '__proto__').set, 2);
      set(test, []);
...
var autocompleteSettings = exports.autocompleteSettings = {
...
var qaSettings = exports.qaSettings = {
   "multipleSpaces": {
      "default": true,
...
var languageSpecificQaSettings = exports.languageSpecificQaSettings = {
...
exports.spreadsheetSettings = undefined;

var _ChromeProxy = __webpack_require__(44);

var spreadsheetSettings = exports.spreadsheetSettings = {
   "spreadsheetURL": {
   ...
   "sheetName": {
      ...
      "imageUrl": _ChromeProxy.ChromeProxy.runtime.getURL('img/sheetnames.png'),
...
var spellcheckSettings = exports.spellcheckSettings = {
   "spellcheckEnabled": {
      "default": true,
...
var translationConsoleSettings = exports.translationConsoleSettings = {
   "tcSearchType": {
